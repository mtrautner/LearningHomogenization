function Amat = sq_fullfieldA_closed(n_data,X,Y,grid_edge,seeds_file)
...
N_nodes = grid_edge^2;
    ...
    A_cells = arrayfun(@(i) A_square_inc_closed([X(i),Y(i)],r,a11,a12,a22,a33,a34,a44),1:N_nodes,'UniformOutput',false); % (dim(A) x N_elem)
